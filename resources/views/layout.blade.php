                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 764 608 195</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> vancuom98.ac@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ url('/') }}"><img src="{{ asset('frontend/images/home/logo_wt.png') }}"
                                    alt="Why-Tech_logo" width="151" height="45"></a>
                        </div>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                @if (session()->has('customer_id') && !session()->has('shipping_id'))
                                    <li><a href="{{ route('checkout.checkout') }}"><i class="fa fa-crosshairs"></i>
                                            Thanh toán</a></li>
                                @elseif (session()->has('customer_id') && session()->has('shipping_id'))
                                    <li><a href="{{ route('checkout.payment') }}"><i class="fa fa-crosshairs"></i>
                                            Thanh toán</a></li>
                                @else
                                    <li><a href="{{ route('checkout.login-checkout') }}"><i
                                                class="fa fa-crosshairs"></i>Thanh toán</a></li>
                                @endif

                                <li><a href="{{ route('cart.show') }}"><i class="fa fa-shopping-cart"></i> Giỏ
                                        hàng</a></li>
                                @if (!session()->has('customer_id'))
                                    <li><a href="{{ route('checkout.login-checkout') }}"><i class="fa fa-lock"></i>
                                            Đăng nhập</a></li>
                                @else
                                    <li><a href="{{ route('checkout.logout-checkout') }}"><i
