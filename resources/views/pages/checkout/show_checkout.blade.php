                            ...
                            @if (!session()->has('customer_id'))
                                <div class="msg u-s-m-b-30">
                                    ...
                                    <span class="msg__text">Bạn là khách hàng?
                                        ...
                                        <a class="gl-link" href="#return-customer" data-toggle="collapse">Đăng
                                            nhập</a></span>
                                            ...
                                            <form class="l-f__form" method="POST" action="{{ route('customer.login') }}">
                                                ...
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-15">
                                                        ...
                                                        <input class="input-text input-text--primary-style" type="email"
                                                            id="login-email" name="customer_email"
                                                    ...
                                                    <div class="u-s-m-b-15">
                                                        ...
                                                        <input class="input-text input-text--primary-style" type="password"
                                                            type="password" id="login-password" name="customer_password"
                                                ...
                                                <div class="check-box">
                                                    ...
                                                    <div class="check-box__state check-box__state--primary">
                                                        ...
                                                        <label class="check-box__label" for="remember-me">Nhớ đăng
                                                            nhập</label>
                                                    </div>
                                                </div>
                                                <!--====== End - Check Box ======-->
                                ...
                                <div class="c-f u-s-m-b-16">
                                    ...
                                    <form class="c-f__form" method="POST" action="{{ route('coupon.check') }}">
                                        ...
                                        <div class="u-s-m-b-16">
                                            ...
                                            <div class="u-s-m-b-15">
                                                <button class="btn btn--e-transparent-brand-b-2 check_coupon"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form class="checkout-f__delivery" method="POST"
                                action="{{ route('checkout.save-checkout') }}">
                                @csrf
                                <div class="u-s-m-b-30">
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input
                                            class="input-text input-text--primary-style @error('shipping_name') is-invalid  @enderror"
                                            type="text" id="billing-email" data-bill="" name="shipping_name"
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input
                                            class="input-text input-text--primary-style @error('shipping_email') is-invalid  @enderror"
                                            type="text" id="billing-email" data-bill="" name="shipping_email"
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input
                                            class="input-text input-text--primary-style @error('shipping_phone') is-invalid  @enderror"
                                            type="text" id="billing-phone" data-bill="" name="shipping_phone"
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input
                                            ...
                                            type="text" id="billing-street" placeholder="Địa chỉ nhà giao hàng" data-bill=""
                                    ...
                                    <div class="u-s-m-b-10">
                                        ...
                                        <div class="check-box">
                                            ...
                                            <div class="check-box__state check-box__state--primary">
                                                ...
                                                <label class="check-box__label" for="make-default-address">Đặt địa chỉ giao
                                                    hàng và thanh toán mặc định</label>
                                            </div>
                                        </div>
                                        <!--====== End - Check Box ======-->
                                    </div>
                                    <div class="u-s-m-b-10">
                                        ...
                                        <textarea class="text-area text-area--primary-style" id="order-note"
                                            name="shipping_notes" style="resize: none"></textarea>
                                    </div>
                                    <div>

                                        <button class="btn btn--e-transparent-brand-b-2" type="submit" name="send_order">LƯU
                                            THÔNG TIN</button>
                                    </div>
                                </div>
                            </form>
                                                ...
                                                <div class="o-card">
                                                    <div class="o-card__flex">
                                                        ...
                                                        <div class="o-card__info-wrap">
                                                            ...
                                                            <span class="o-card__quantity">Số lượng x
                                                                {{ $item['product_quantity'] }}</span>

                                                            <span
                                                                class="o-card__price">{{ number_format($item['product_info']->product_price) }}
                                                                VNĐ</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="ship-b">
                                            ...
                                            @if (session()->has('shipping_id'))
                                                <div class="ship-b__box u-s-m-b-10" style="display: block;">
                                                    ...
                                                    <p class="ship-b__p">
                                                        <i>Địa chỉ giao hàng:
                                                        </i>{{ session()->get('shipping_address') }}
                                                    </p>

                                                    <a class="ship-b__edit btn--e-transparent-platinum-b-2"
                                                        data-modal="modal" data-modal-id="#edit-ship-address">Chỉnh sửa</a>
                                                </div>
                                            @else
                                                <div class="ship-b__box u-s-m-b-10" style="display: block;">
                                                    <p class="ship-b__p">
                                            ...
                                            <tbody>
                                                ...
                                                @if (session()->has('cart') && count(session()->get('cart')) > 0)
                                                    ...
                                                    @if (session()->has('coupon'))
                                                        <tr>
                                                            <a class="ship-b__edit btn--e-transparent-platinum-b-2"
                                                                data-modal="modal" data-modal-id="#edit-ship-address"
                                                                href="{{ route('coupon.unset') }}">Xóa mã giảm giá</a>
                                                        </tr>
                                                        @foreach (session()->get('coupon') as $coupon)
                                                            ...
                                                            @else
                                                                ...
                                                                <tr>
                                                                    <td>ÁP DỤNG MÃ GIẢM GIÁ</td>
                                                                    <td>{{ number_format($coupon['coupon_number']) }} VNĐ
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                    ...
                                    <div class="o-summary__box">
                                        ...
                                        <form class="checkout-f__payment" method="POST"
                                            ...
                                            <div class="u-s-m-b-10">
                                                ...
                                                <span class="gl-text u-s-m-t-6">Thực hiện thanh toán của bạn trực tiếp vào
                                                    tài khoản ngân hàng của chúng tôi. Vui lòng sử dụng ID đơn đặt hàng của
                                                    bạn làm tham chiếu thanh toán. Đơn đặt hàng của bạn sẽ không được chuyển
                                                    cho đến khi tiền đã hết trong tài khoản của chúng tôi.</span>
                                            </div>
                                            {{-- <div class="u-s-m-b-10">
                                            ...
                                            <div class="u-s-m-b-15">
                                                ...
                                                <div class="check-box">
                                                    ...
                                                    <div class="check-box__state check-box__state--primary">
                                                        ...
                                                        <label class="check-box__label" for="term-and-condition">Tôi đồng ý
                                                            với</label>
                                                    </div>
                                                </div>
                                                <!--====== End - Check Box ======-->
