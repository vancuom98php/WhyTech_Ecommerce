            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="{{ route('product.detail', ['product_slug' => $top_products[0]->product_slug]) }}">
                            <div class="aspect aspect--bg-grey aspect--square">

                                <img class="aspect__img collection__img"
                                    src="{{ asset($top_products[0]->product_image_path) }}" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="{{ route('product.detail', ['product_slug' => $top_products[1]->product_slug]) }}">
                            <div class="aspect aspect--bg-grey aspect--1286-890">

                                <img class="aspect__img collection__img"
                                    src="{{ asset($top_products[1]->product_image_path) }}" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="{{ route('product.detail', ['product_slug' => $top_products[2]->product_slug]) }}">
                            <div class="aspect aspect--bg-grey aspect--1286-890">

                                <img class="aspect__img collection__img"
                                    src="{{ asset($top_products[2]->product_image_path) }}" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="{{ route('product.detail', ['product_slug' => $top_products[3]->product_slug]) }}">
                            <div class="aspect aspect--bg-grey aspect--square">

                                <img class="aspect__img collection__img"
                                    src="{{ asset($top_products[3]->product_image_path) }}" alt="">
                            </div>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    @foreach ($productByCategory as $product)
                                        <div
                                            class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item {{ $category->category_id }}">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                    ...
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                                                ...
                                                                <a data-modal="modal"
                                                                    data-modal-id="#{{ $product->product_slug }}"
                                                ...
                                                <div class="product-o__rating gl-rating-style">
                                                    ...
                                                    <span
                                                        class="product-o__review">({{ $product->comments->where('comment_parent_comment', 0)->count() }})</span>
                                                </div>

                                                <span
                                                    class="product-o__price">{{ number_format($product->product_price) }}
                                                    VNĐ</span>
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="{{ asset('frontend/images/promo/promo-img-1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="{{ asset('frontend/images/promo/promo-img-2.jpg') }}" alt="">
                            </div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="{{ asset('frontend/images/promo/promo-img-3.jpg') }}" alt="">
                            </div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
