        ...
        <div class="shop-p">
            <div class="shop-p__toolbar u-s-m-b-30">
                <div class="shop-p__meta-wrap u-s-m-b-60">
                    ...
                    <span class="shop-p__meta-text-1">KẾT QUẢ TÌM KIẾM</span>
                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="u-s-m-b-8">
                            <select name="sort" id="sort" class="select-box select-box--transparent-b-2">
                                <option value="{{ Request::url() }}?sort_by=new" selected>Sắp xếp: Mới nhất</option>
                                <option value="{{ Request::url() }}?sort_by=old">Sắp xếp: Cũ nhất</option>
                                <option value="{{ Request::url() }}?sort_by=az">Sắp xếp: A-Z</option>
                                <option value="{{ Request::url() }}?sort_by=za">Sắp xếp: Z-A</option>
                                <option value="{{ Request::url() }}?sort_by=inc">Sắp xếp: Giá tăng dần</option>
                                <option value="{{ Request::url() }}?sort_by=desc">Sắp xếp: Cao giảm dần</option>
                            </select>
                        </div>
                    </form>
                </div>
