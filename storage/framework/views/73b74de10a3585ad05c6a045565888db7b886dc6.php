            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="<?php echo e(route('product.detail', ['product_slug' => $top_products[0]->product_slug])); ?>">
                            <div class="aspect aspect--bg-grey aspect--square">

                                <img class="aspect__img collection__img"
                                    src="<?php echo e(asset($top_products[0]->product_image_path)); ?>" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="<?php echo e(route('product.detail', ['product_slug' => $top_products[1]->product_slug])); ?>">
                            <div class="aspect aspect--bg-grey aspect--1286-890">

                                <img class="aspect__img collection__img"
                                    src="<?php echo e(asset($top_products[1]->product_image_path)); ?>" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="<?php echo e(route('product.detail', ['product_slug' => $top_products[2]->product_slug])); ?>">
                            <div class="aspect aspect--bg-grey aspect--1286-890">

                                <img class="aspect__img collection__img"
                                    src="<?php echo e(asset($top_products[2]->product_image_path)); ?>" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection"
                            href="<?php echo e(route('product.detail', ['product_slug' => $top_products[3]->product_slug])); ?>">
                            <div class="aspect aspect--bg-grey aspect--square">

                                <img class="aspect__img collection__img"
                                    src="<?php echo e(asset($top_products[3]->product_image_path)); ?>" alt="">
                            </div>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $productByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div
                                            class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item <?php echo e($category->category_id); ?>">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                    ...
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                                                ...
                                                                <a data-modal="modal"
                                                                    data-modal-id="#<?php echo e($product->product_slug); ?>"
                                                            ...
                                                            <li>
                                                                <form method="POST">
                                                                    ...
                                                                    <button
                                                                        class="btn btn--e-brand btn-add-cart btn-add-cart-home"
                                                ...
                                                <div class="product-o__rating gl-rating-style">
                                                    ...
                                                    <span
                                                        class="product-o__review">(<?php echo e($product->comments->where('comment_parent_comment', 0)->count()); ?>)</span>
                                                </div>

                                                <span
                                                    class="product-o__price"><?php echo e(number_format($product->product_price)); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="banner-bg__wrap">
                            ...
                            <span class="banner-bg__text-block banner-bg__text-3 u-c-secondary">Miễn phí vận chuyển khi mua
                                từ 2 sản phẩm!</span>

                            <a class="banner-bg__shop-now btn--e-secondary" href="shop-side-version-2.html">Mua sắm
                                ngay!</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <li>
                                                <form method="POST">
                                                    ...
                                                    <button class="btn btn--e-brand btn-add-cart btn-add-cart-home"
                                                        ...
                                                        data-modal-id="#add-to-cart-<?php echo e($product->product_slug); ?>"
                                                        data-tooltip="tooltip" data-placement="top"
                                                        data-id_product="<?php echo e($product->product_id); ?>" name="add_cart"><i
                                                            class="fas fa-plus-circle fa-add-cart"></i></button>
                                                </form>
                                            </li>
                                            <li>
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="<?php echo e(asset('frontend/images/promo/promo-img-1.jpg')); ?>" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="<?php echo e(asset('frontend/images/promo/promo-img-2.jpg')); ?>" alt="">
                            </div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img"
                                    src="<?php echo e(asset('frontend/images/promo/promo-img-3.jpg')); ?>" alt="">
                            </div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
