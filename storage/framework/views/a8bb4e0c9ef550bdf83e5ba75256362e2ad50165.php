                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="sub-menu_item"><a href="<?php echo e(route('category-product.create')); ?>">Thêm danh
                                        mục sản phẩm</a></li>
                                <li class="sub-menu_item"><a href="<?php echo e(route('category-product.all')); ?>">Liệt kê danh
                                        mục sản phẩm</a></li>
                            </ul>
                        </li>
