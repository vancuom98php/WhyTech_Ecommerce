    ...
    <div class="w3layouts-main">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="input-box">
                ...
                <input id="admin_email" type="email" class="ggg" name="admin_email" value="<?php echo e(old('admin_email')); ?>"
                ...
                <div class="col-md-6">
                    <a href="<?php echo e(route('admin.google')); ?>" class="btn btn-danger" style="height: 40px;">
                        <i style="line-height: 25px;"><img class="btn__google-logo"
                                src="<?php echo e(asset('backend/images/google-logo.png')); ?>" style="width:18px;" alt=""></i>
